                                                ...
                                                <div class="col-lg-6">
                                                    <div class="pricing-box ">
                                                        ...
                                                        <div class="pricing-plan mt-4 pt-2">
                                                            ...
                                                            <h4 class="text-muted">
                                                                ...
                                                                <span class="plan pl-3 text-dark">₹
                                                                    <?php echo number_format($newCost, 2); ?> </span>
                                                                <p class="d-inline text-success mb-0 small"
                                                                    style="margin-left: -0.5rem !important;">(28% Off)</p>
                                                            </h4>

                                                            <p class="text-muted mb-0">
                                                                <i class="mdi mdi-calendar me-2" style="font-size: 18px;"></i>
                                                                <?php echo $Plan['PlanDuration']; ?>&nbsp;<?php echo $Plan['PlanDurationFormat']; ?>
                                                            </p>
                                                            <p class="text-muted mb-0">
                                                                <?php
                                                                if ($Plan['PlanFamilyMember'] == 1) {
                                                        ...
                                                        <div class="mt-4 pt-3">
                                                            ...
                                                            ?>
                                                            <a href="view-plan-details.php?id=<?php echo htmlspecialchars($encryptedPlanID); ?>"
                                                                class="btn site-button appointment-btn btnhover13 btn-rounded">View
                                                                Plan Details</a>
                                                        </div>
