<head>
	...
	<title>Faq's-United Health Lumina</title>
				...
				<div class="section-full overlay-white-middle content-inner">
					<div class="container">
						<div class="section-head text-black text-center">
							...
							<p>United Health Lumina Always Ready to Help You </p>
						</div>
						<div class="row">
							<div class="col-lg-6 col-md-12 m-b30">
								...
								<i class="flaticon-play-button text-white"></i></a> -->
									<img src="project-assets/images/faq's.jpg" alt="" class="img-cover radius-sm">
								</div>
							</div>
							<div class="col-lg-6 col-md-12 m-b30">
								<div class="dlab-accordion faq-1 box-sort-in m-b30" id="accordion1">
									...
									<div class="panel">
										...
										<div id="faq3" class="acod-body collapse" data-bs-parent="#accordion1">
											<div class="acod-content"> Yes, United Health Lumina provides customizable health plan options to
												cater to specific medical needs, lifestyle requirements, and family size.
											</div>
										</div>
									</div>
									<div class="panel">
									...
									<div class="panel">
										...
										<div id="faq5" class="acod-body collapse" data-bs-parent="#accordion1">
											<div class="acod-content">Yes, United Health Lumina includes preventive health benefits like
												routine check-ups, health screenings, and wellness programs to support overall well-being.</div>
										</div>
									</div>
									...
									<div class="panel">
										<div class="acod-head">
											<h6 class="acod-title">
												<a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#faq6" class="collapsed"
													aria-expanded="false">
										...
										<div id="faq6" class="acod-body collapse" data-bs-parent="#accordion1">
											<div class="acod-content">United Health Lumina partners with a network of hospitals and clinics to
												provide seamless access to quality healthcare services.</div>
										</div>
									</div>
									...
									<div class="panel">
										<div class="acod-head">
											<h6 class="acod-title">
												<a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#faq7" class="collapsed"
													aria-expanded="false">
										...
										<div id="faq7" class="acod-body collapse" data-bs-parent="#accordion1">
											<div class="acod-content">Yes, United Health Lumina allows you to add family members to your plan,
												ensuring comprehensive coverage for your spouse, children, or other dependents.</div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-4  mb-3">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe width="350" height="200" src="https://www.youtube.com/embed/cLbAXER7nPg?si=MaOMxEfla-dOEl84"
						...
						<div class="col-md-4  mb-3">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe width="350" height="200" src="https://www.youtube.com/embed/IXUzh5ln6_c?si=ouzac56P7_kkDBtX"
									title="YouTube video player" frameborder="0"
									allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
									referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
						...
						<div class="col-md-4  mb-3">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe width="350" height="200" src="https://www.youtube.com/embed/OhE1jyixS64?si=s63HmuZcbt1yP9RW"
									title="YouTube video player" frameborder="0"
									allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
									referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
