<!-- Footer -->
    <footer class="site-footer style1">
        ...
        <!-- footer top part -->
        <div class="footer-top" style="background-image:url(project-assets/images/background/bg2.png); background-size: contain;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="widget">
                            ...
                            <ul class="list-2">
                                ...
                                <li><a href="./grievance-redressa">Grievance Redressa</a></li>
                                <li><a href="./terms-conditions">Terms-Conditions</a></li>
                                <li><a href="./cancellation-and-refund-policy">Cancellation and Refund Policy</a></li>
                                <li><a href="./all-plans.php">Plans</a></li>
