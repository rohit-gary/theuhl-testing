		...
		<div class="main-bar clearfix ">
			<div class="container clearfix">
				...
				<div class="logo-header mostion">
					<a href="./index"><img src="project-assets/images/uhlnewlogo.png" alt="" ></a>
				</div>
				<!-- nav toggle button -->
				...
				<div class="extra-nav">
					<div class="extra-cell">
					    <a href="uhladmin/admin/authentication/login" id="login-btn" class="site-button appointment-btn btnhover13" target="_blank">Login Here</a>
					</div>
				...
				<div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
					...
					<ul class="nav navbar-nav align-items-center" >	
						...
						<li><a href="./about-us">About us <i class="fas fa-chevron-down"></i></a></li>
						<li><a href="./all-plans">Our Health Plans<i class="fas fa-chevron-down"></i></a></li>
						<li><a href="./blogs">Blog<i class="fas fa-chevron-down"></i></a></li>
						<li><a href="./faqs">FAQ'S<i class="fas fa-chevron-down"></i></a></li>
						<li><a href="./contact-us">Contact Us<i class="fas fa-chevron-down"></i></a></li>
						<li class="">
