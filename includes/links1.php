...
<link rel="shortcut icon" type="image/x-icon"
  href="<?php echo $base_url; ?>/project-assets/images/favicon/uhlfavtemp.png">
...
<link rel="stylesheet" type="text/css"
  href="<?php echo $base_url; ?>/project-assets/plugins/revolution/revolution/css/revolution.min.css">
