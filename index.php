...
<!-- header END -->
    ...
    <div class="overlaytextbanner dz-media upper-bnr position-relative">
        <div class="container position-relative">
            <!-- Banner Image -->
            <img src="project-assets/images/banner/Desktop-Banner.png" alt="Banner Image" class="img-fluid" style="width: 100%;">
            ...
            <div class="bottom-left d-flex justify-content-center position-absolute text-white w-100">
                <div class="feature-item"><h4>Free Doctor Consultation</h4></div>
                <div class="feature-item"><h4>24*7 Claims Support</h4></div>
                <div class="feature-item"><h4> Quick reimbursement</h4></div>
                <div class="feature-item"><h4>Zero waiting period</h4></div>
    ...
    <!-- <div class="col-12 position-relative d-block d-md-none"> 
     ...
     <div class="col-12 position-relative d-block d-md-none"> 
        ...
        <div class="container position-relative">
            <!-- Banner Image -->
            <img src="project-assets/images/banner/mobile-banner-3.jpg" alt="Banner Image" class="img-fluid" style="width: 100%;">
            ...
            <div class="top-left">
                ...
                <div class="mobile-banner-btn">
                    <!-- Main Heading -->
                    <h4 class="text-uppercase white-strip btnhover13" id="talktoexpert-mobile" onclick="scrollToSection()">Check Our Plans</h4>
            ...
            <div class="bottom-left-mobile d-flex justify-content-center position-absolute text-white w-100">
                <div class="feature-item-mobile"><h4>Free Doctor Consultation</h4></div>
                <div class="feature-item-mobile"><h4>24*7 Claims Support</h4></div>
                <div class="feature-item-mobile"><h4> Quick reimbursement</h4></div>
                <div class="feature-item-mobile"><h4>Zero waiting period</h4></div>
                <div class="feature-item-mobile"><h4>Largest Network</h4></div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" id="planSelect" name="planSelect" required>
                                        ...
                                        <option value="HAPPY SURAKSHA UNLIMITED (FAMILY FLOATER 3.0)">HAPPY SURAKSHA UNLIMITED (FAMILY FLOATER 3.0)</option>
                                        <option value="HAPPY SURAKSHA UNLIMITED (MAIGNIT 2.0)">HAPPY SURAKSHA UNLIMITED (MAIGNIT 2.0)</option>
...
<div class="container" style="margin-top:-2em">
        ...
        <h2 class="title text-center">How to knows Which <span class="text-primary">Health Plan Do you need ?</span></h2>
           
            <p>Figuring out your health plan coverage can seem detailed, but it becomes easy once you understand it better. Here's what you should think about when calculating how much health plan coverage you need</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/your-family.svg" class="card-img-top" alt="Health Plan for your Family’s Financial Security">
                    <div class="card-body">
                        <h3 class="card-title">Assess Your Healthcare Needs</h3>
                        <p class="card-text">Consider your medical history, any chronic conditions, and frequency of doctor visits.If you have dependents, evaluate their healthcare needs as well.</p>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/your-financial.svg" class="card-img-top" alt="Income-Based Health Plan Coverage">
                    <div class="card-body">
                        <h3 class="card-title">Flexibility</h3>
                        <p class="card-text">Choose between plans like HMOs, PPOs, or high-deductible options based on how much flexibility you want in choosing providers.</p>
                    </div>
                </div>
            </div>
             </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/income-replace.svg" class="card-img-top" alt="Income Replacement Insurance">
                    <div class="card-body">
                        <h3 class="card-title">Check Network Coverage</h3>
                        <p class="card-text">Ensure your preferred doctors, hospitals, and specialists are in the plan’s network to avoid higher costs.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">We provide a great customer service & support. We value you and your health. You have a query, feel free to call us, it will be our pleasure to help you out.</p>
                    </div>
                </div>
            </div>
              </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/medical-emergency.svg" class="card-img-top" alt="Medical Emergencies Insurance">
                    <div class="card-body">
                        <h3 class="card-title">Future Considerations</h3>
                        <p class="card-text">Think about any changes in your health needs that may arise in the coming years and whether the plan can accommodate them.</p>
                    </div>
                </div>
            </div>
            <!-- Card 6 -->
            <div class="col-md-6 col-lg-6">
            <div class="card h-100 d-flex flex-row align-items-center">
          <img src="project-assets/images/icon/change-life.svg" class="card-img-top" alt="Changes in Life Stage Insurance">
          <div class="card-body text-start">
            <h3 class="card-title">Prescription Medicine Coverage</h3>
            <p class="card-text">If you take regular medications, review the plan’s formulary (list of covered drugs) and the cost-sharing structure for prescriptions</p>
        </div>
    </div>
</div>
    ...
    <div class="container" style="margin-top: 4rem;">
        <div class="">
            <h2 class="title text-center">Medical Subscription Health Plans for <span class="text-primary">every stage of your life </span></h2>
        </div>
        ...
        <div class="dz-bannerlist d-none d-md-block" style="margin-top:3em">
            <ul class="nav nav-tabs dz-bannerlist d-flex justify-content-space-evenly" id="insuranceTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="term-plans-tab" data-bs-toggle="tab" href="#term-plans" role="tab" aria-controls="term-plans" aria-selected="true">REGULAR HEALTH GUARD (INDIVIDUAL)</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="savings-plans-tab" data-bs-toggle="tab" href="#savings-plans" role="tab" aria-controls="savings-plans" aria-selected="false">REGULAR HEALTH GUARD 2.0</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="ulip-plans-tab" data-bs-toggle="tab" href="#ulip-plans" role="tab" aria-controls="ulip-plans" aria-selected="false">REGULAR HEALTH GUARD 3.0</a>
                </li>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#insuranceAccordion">
                    <div class="accordion-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="project-assets/images/plan/dummyplan.png" class="img-fluid" alt="REGULAR HEALTH GUARD (INDIVIDUAL)">
                            </div>
                            <div class="col-md-8">
                                <h3>REGULAR HEALTH GUARD (INDIVIDUAL)</h3>
                                <p>A<a href="#" class="text-primary fw-bold"><u>REGULAR HEALTH GUARD (INDIVIDUAL)</u></a>OPD-based subscription  health plan offers comprehensive support for outpatient care, covering doctor consultations with general physicians and specialists, diagnostic tests like X-rays and blood work, and prescribed medications—all helping to make routine treatments more affordable. It also includes mental health services such as counseling and psychotherapy, ensuring care for emotional well-being. With a fast, hassle-free claims process, including options for reimbursement or direct billing, you can reduce out-of-pocket expenses. Plus, 24/7 claim support ensures help is available whenever you need it.
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=OQ==" class="text-primary fw-bold">
                                    </div>
                                </div>
                                <div class="d-flex gap-3 mt-3">
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=OQ==" class="btn site-button appointment-btn btnhover13 btn-rounded">Buy Plan</a>
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=OQ==" class="btn btn-outline-success">Know More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p>REGULAR HEALTH GUARD 2.0 are <a href="/life-insurance-plans.html" class="text-primary fw-bold"><u>REGULAR HEALTH GUARD 2.0</u></a> OPD-based health plans provide budget-friendly coverage for everyday healthcare needs. They include limited coverage for consultations with general physicians and specialists, as well as partial or full coverage for diagnostic tests like X-rays and blood tests. Prescribed medications from OPD visits are covered, making treatments more affordable. The plans also offer access to wellness programs for stress management and mindfulness, plus limited e-sessions with nutritionists and psychologists. With hassle-free reimbursement and direct billing, members experience minimal out-of-pocket costs, supported by 24/7 claim assistance for added convenience.
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4>Validity - 1 year with 365 days cancellation</h4>
                                ...
                                <div class="d-flex gap-3 mt-3">
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=MTA=" class="btn site-button appointment-btn btnhover13 btn-rounded">Buy Plan</a>
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=MTA=" class="btn btn-outline-success">Know More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p>OPD-based health plans offer comprehensive coverage for everyday healthcare, including unlimited consultations with general physicians and specialists, as well as unlimited diagnostic tests like X-rays and blood tests. They cover all prescribed medications, making treatments affordable, and provide access to wellness programs for stress management and mindfulness. Members can enjoy unlimited e-sessions with nutritionists and psychologists, along with hassle-free reimbursement and direct billing to reduce out-of-pocket costs. The plans also include annual health check-ups for the family and regular dental and eye exams, with the flexibility to add or remove family members. Plus, 24/7 claim support is always available.
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="d-flex gap-3 mt-3">
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=MTE=" class="btn site-button appointment-btn btnhover13 btn-rounded">Buy Plan</a>
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=MTE=" class="btn btn-outline-success">Know More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- (same content as inside accordion) -->
                 <!-- REGULAR HEALTH GUARD (INDIVIDUAL) Content -->
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <h3>REGULAR HEALTH GUARD (INDIVIDUAL)</h3>
                                <p>A <a href="#" class="text-primary fw-bold"><u>REGULAR HEALTH GUARD (INDIVIDUAL)</u></a> An OPD-based subscription  health plan offers comprehensive support for outpatient care, covering doctor consultations with general physicians and specialists, diagnostic tests like X-rays and blood work, and prescribed medications—all helping to make routine treatments more affordable. It also includes mental health services such as counseling and psychotherapy, ensuring care for emotional well-being. With a fast, hassle-free claims process, including options for reimbursement or direct billing, you can reduce out-of-pocket expenses. Plus, 24/7 claim support ensures help is available whenever you need it.
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4>Validity - 1 year with 365 days cancellation</h4>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><a href="/blogs/life-insurance/know-the-tax-benefits-of-insurance-policies.html" class="text-primary fw-bold">
                                    </div>
                                </div>
                                <div class="d-flex gap-3 mt-3">
                                    <a href="https://unitedhealthlumina.com/uhl/view-plan-details.php?id=OQ==" class="btn site-button appointment-btn btnhover13 btn-rounded">Buy Plan</a>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4 d-flex justify-content-center align-items-center mb-4 mb-md-0">
                <div class="newbie-lhs ani-rhs">
                    <img class="img-fluid" src="project-assets/images/happy-member_compressed.png" alt="Happy Customer Image | UHL Health" title="Happy Customer Image">
                </div>
            </div>
...
<div class="container" style="margin-top: -1.5em">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/wealth-plans.svg" class="card-img-top" alt="Health Plan for your Family’s Financial Security">
                    <div class="card-body">
                        <h3 class="card-title">Medical Protection</h3>
                        <p class="card-text"> United Health Lumina  health plans offer free or low-cost preventative care (e.g., annual check-ups,   vaccinations, screenings) to catch potential health issues early, reducing the need for more expensive treatments later.</p>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/performance.svg" class="card-img-top" alt="Income-Based Health Plan Coverage">
                    <div class="card-body">
                        <h3 class="card-title">Prescription Medicine Coverage</h3>
                        <p class="card-text">United Health Lumina Health plans often include coverage for prescription medications, helping to manage the costs of both generic and brand-name drugs. Most of our  plans provide a list of approved pharmacies where individuals can fill prescriptions at lower prices.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/assured-return.svg" class="card-img-top" alt="Income Replacement Insurance">
                    <div class="card-body">
                        <h3 class="card-title">Mental Health and Wellness Benefits</h3>
                        <p class="card-text">Our health plans include coverage for mental health services, such as therapy, counseling, and psychiatric care, which can be critical for overall well-being.
                        Some Health plans offer programs or incentives to encourage healthy behaviors, such as fitness discounts, smoking cessation programs, and weight management resources.
                       </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100 d-flex flex-row align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">These plans often include coverage for consultations, reducing out-of-pocket lab test expenses</p>
                    </div>
                </div>
            </div>
              </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card h-100d-flex flex-row align-items-center">
                    <img src="project-assets/images/icon/low-premium.svg" class="card-img-top" alt="Medical Emergencies Insurance">
                    <div class="card-body">
                        <h3 class="card-title">Telemedicine and Virtual Care</h3>
                        <p class="card-text">Our health plans now cover telemedicine visits, allowing individuals to consult with doctors remotely, saving time and reducing exposure to illnesses in waiting rooms. Virtual visits are often less expensive than in-person visits, providing a more affordable alternative for non-emergency situations</p>
                    </div>
                </div>
            </div>
            <!-- Card 6 -->
            <div class="col-md-6 col-lg-6">
            <div class="card h-100 d-flex flex-row align-items-center">
          <img src="project-assets/images/icon/low-premium.svg" class="card-img-top" alt="Changes in Life Stage Insurance">
          <div class="card-body text-start">
            <h3 class="card-title">Peace of Mind</h3>
            <p class="card-text">Knowing that unexpected medical expenses are covered can relieve stress and provide peace of mind. Plans allows individuals to focus on their health and well-being without worrying about financial strain.
            </p>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        <form id="tte-review-form_second">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <label for="needformName" class="form-label">Name</label>
                                      <input type="text" class="form-control" id="needformName_second" name="needformName"  placeholder="Enter full name" required>
                                    <div class="invalid-feedback">Please enter your name.</div>
                                </div>
                                <div class="col-md-12">
                                    <label for="needformMobile" class="form-label">Mobile No.</label>
                                    <div class="input-group">
                                        <span class="input-group-text">+91</span>
                                        <input type="tel" class="form-control" id="needformMobile_second" name="needformMobile" placeholder="Enter mobile number" maxlength="10" required>
                                        <div class="invalid-feedback">Please enter your mobile number.</div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12 mt-4">
                                    <button type="submit" class="btn site-button appointment-btn btnhover13 btn-rounded"onclick="Submitenquiry_2(event)" >Get a Call Back</button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center">
                <img class="img-fluid" src="project-assets/images/icon/connect-to-get.svg" alt="Happy Customer Image | UHL Health" title="Happy Customer Image" style="height: 90%; object-fit: contain;">
            </div>
        </div>
    </div>
</section>
...
<div class="section-full bg-gary content-inner" style="background-color:aliceblue;">
  ...
  <div class="container">
    <div class="section-head text-center">
      ...
      <p>United Health Lumina (UHL) offers an affordable, subscription-based health plan with flexible options. It covers essential medical services, preventive care, and wellness benefits, providing hassle-free access to quality healthcare without high upfront costs.</p>
    </div>
...
<section class="section-full bg-white content-inner mt-3" style="">
    <div class="choose-us-sec choose-us-sec-ht" data-aos="fade" data-aos-duration="1000" data-aos-delay="300" data-aos-offset="300">
        <div class="container">
            <div class="section-title text-center mb-5">
              <h2 class="title">Why Choose <span class="text-primary">UHL Health Plans</span></h2>
                
                <p>Select UHL Health Plans for comprehensive, affordable, and customizable healthcare coverage tailored to your needs. With a network of top-tier healthcare providers, competitive premiums, and a variety of plan options, you can ensure quality care for you and your family. 
                Our customer service and wellness programs prioritize your health and provide peace of mind, making UHL  the ideal choice for your health plan needs</p>
            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6 col-md-6 col-6">
                            <div class="card  text-center p-3 border-0">
                                <img src="project-assets/images/icon/Families-protected-so-far.svg" class="mx-auto" alt="Families protected">
                                <div class="card-body">
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                            <div class="card  text-center p-3 border-0">
                                <img src="project-assets/images/icon/Crores-Retail-Sum-Assured.svg" class="mx-auto" alt="Retail Sum Assured">
                                <div class="card-body">
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                            <div class="card  text-center p-3 border-0">
                                <img src="project-assets/images/icon/Assets-Under-Management.svg" class="mx-auto" alt="Assets Under Management">
                                <div class="card-body">
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                            <div class="card  text-center p-3 border-0">
                                <img src="project-assets/images/icon/Claim-Settlement-Ratio.svg" class="mx-auto" alt="Claim Settlement Ratio">
                                <div class="card-body">
              ...
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <div class="testimonial-text">
                    <p>Being the sole breadwinner, I was worried about my aging parents. UHL health plan  provided the ideal coverage with additional benefits like fastest claim settlement .</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Rahul Kashyap</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <div class="testimonial-text">
                    <p>Choosing UHL HEALTH PLANS  felt like an adventure. The website guided me smoothly and I was thrilled with the ease of comparison. Cheers UHL. The website guided me smoothly</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Adarsh Kumar</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <div class="testimonial-text">
                    <p>Having  UHL  heath  plan  which is so beneficial and the investment is also low. Service provided is quick and on time. Online renewals are made so simple through online portal service.</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Kushagra</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <!-- <div class="testimonial-pic radius style1"><img src="project-assets/images/testimonials/pic1.jpg" width="100" height="100" alt=""></div> -->
                  <div class="testimonial-text">
                    <p>I got the UHL Health Plan at a low cost, and the coverage is as high as promised. The service is excellent, and their staff is available 24/7 to assist with any inquiries.</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Mahima Pandey</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <!-- <div class="testimonial-pic radius style1"><img src="project-assets/images/testimonials/pic2.jpg" width="100" height="100" alt=""></div> -->
                  <div class="testimonial-text">
                    <p>I’m securing my future by investing in the UHL Health Plan and opting for their retirement health plans. In my opinion, it’s the best investment, as the policy covers 92% of my healthcare needs.</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Ajeet</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <!-- <div class="testimonial-pic radius style1"><img src="project-assets/images/testimonials/pic3.jpg" width="100" height="100" alt=""></div> -->
                  <div class="testimonial-text">
                    <p>The claims process is easy due to the fast service provided by their dedicated staff. Plus, it offers tax-saving benefits, which is another great advantage. I'm very satisfied with it.</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Chitransh Trivedi</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <!-- <div class="testimonial-pic radius style1"><img src="project-assets/images/testimonials/pic1.jpg" width="100" height="100" alt=""></div> -->
                  <div class="testimonial-text">
                    <p>I purchased the UHL Health Plan, opting for their term health coverage. The premiums are affordable, around Rs. 10K per year, making it a great option for my budget.</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Tushar</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <!-- <div class="testimonial-pic radius style1"><img src="project-assets/images/testimonials/pic2.jpg" width="100" height="100" alt=""></div> -->
                  <div class="testimonial-text">
                    <p>I have the UHL Health Plan for my family of four, and it has proven to be reliable with many benefits and great returns on investment. The policy coverage is around 90%.</p>
                  </div>
                  <div class="testimonial-detail"> <strong class="testimonial-name">Naina Verma</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
              <div class="item p-a5">
                <div class="testimonial-9">
                  ...
                  <div class="testimonial-detail"> <strong class="testimonial-name">Anil</strong> <span class="testimonial-position">People</span> </div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="section-full bg-white content-inner" style="margin-bottom: 5rem;" style="background-color:white;">
            ...
            <div class="col-md-12">
                <div class="card gradient-bg">
                    ...
                    <div class="card-body">
                       ...
                       <h2 class="title text-center">Purchase / Renew Subscription <span class="text-primary">Health Plan Online</span></h2>
                        <p class="text-center">If you are an existing UHL family member ,  <a href="#" style="color: rgb(0,115,187);font-weight: bold;">you can quickly renew your subscription online</a> here!</p> 
      ...
      <!-- Latest blog -->
      <div class="section-full  wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" style="background-color:aliceblue; margin-top:-3em">
        <div class="container content-inner">
          <div class="section-head text-center">
            <h2 class="title">Latest <span class="text-primary">blog post</span></h2>
            <p>Our health plan offers comprehensive coverage with free doctor consultations, 24/7 claims support, and fast claim settlements. Enjoy peace of mind with  Quick reimbursement and access to the largest health network</p>
          </div>
          <div class="blog-carousel owl-none owl-carousel">
            <div class="item">
              <div class="blog-post post-style-1">
                <div class="dlab-post-media dlab-img-effect rotate">
                  <a href="your-guide-to-choosing-the-right-coverage"><img src="project-assets/images/blog/latest-blog/blog2.jpg" alt=""></a>
                </div>
                <div class="dlab-post-info">
                  ...
                  <div class="dlab-post-title">
                    <h3 class="post-title"><a href="your-guide-to-choosing-the-right-coverage">Health Plans Unpacked: Your Guide to Choosing the Right Coverage</a></h3>
                  </div>
                  <div class="dlab-post-readmore">
                    <a href="your-guide-to-choosing-the-right-coverage" title="READ MORE" rel="bookmark" class="site-button btnhover13">READ MORE</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="blog-post post-style-1">
                <div class="dlab-post-media dlab-img-effect rotate">
                  <a href="how-virtual-care-is-transforming-patient-experiences"><img src="project-assets/images/blog/latest-blog/blog1.jpg" alt=""></a>
                </div>
                <div class="dlab-post-info">
                  <div class="dlab-post-meta">
                    <ul>
                      <li class="post-date"> <strong>22 Oct</strong> <span> 2024</span> </li>
                      <li class="post-author"> By <a href="how-virtual-care-is-transforming-patient-experiences">UHL</a> </li>
                    </ul>
                  </div>
                  <div class="dlab-post-title ">
                    <h3 class="post-title"><a href="how-virtual-care-is-transforming-patient-experiences">The Rise of Telemedicine: How Virtual Care is Transforming Patient Experiences
                    </a></h3>
                  </div>
                  <div class="dlab-post-readmore">
                    <a href="how-virtual-care-is-transforming-patient-experiences" title="READ MORE" rel="bookmark" class="site-button btnhover13">READ MORE</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="blog-post post-style-1">
                <div class="dlab-post-media dlab-img-effect rotate"> 
                  <a href="how-green-practices-are-Impacting-the-medical-industry"><img src="project-assets/images/blog/latest-blog/blog3.jpg" alt=""></a>
                </div>
                <div class="dlab-post-info">
                  <div class="dlab-post-meta">
                    <ul>
                      <li class="post-date"> <strong>22 Oct</strong> <span> 2024</span> </li>
                      <li class="post-author"> By <a href="how-green-practices-are-Impacting-the-medical-industry">UHL</a> </li>
                    </ul>
                  </div>
                  <div class="dlab-post-title">
                    <h3 class="post-title"><a href="how-green-practices-are-Impacting-the-medical-industry">Sustainable Healthcare: How Green Practices Are Impacting the Medical Industry
                    </a></h3>
                  </div>
                  <div class="dlab-post-readmore">
                    <a href="how-green-practices-are-Impacting-the-medical-industry" title="READ MORE" rel="bookmark" class="site-button btnhover13">READ MORE</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="dlab-accordion faq-2 box-sort-in" id="accordion1">
                <div class="panel">
                  ...
                  <div id="faq1" class="acod-body collapse" data-bs-parent="#accordion1">
                    <div class="acod-content">United Health Lumina's subscription plans offer a range of benefits, including comprehensive coverage for outpatient department (OPD) services, in-patient treatment, and preventive care, with flexible claim options.
                    </div>
                  </div>
                </div>
                <div class="panel">
                  ...
                  <div id="faq2" class="acod-body collapse" data-bs-parent="#accordion1">
                    <div class="acod-content">United Health Lumina’s OPD-based health plans allow claims on outpatient treatments, offering subscribers flexibility for medical consultations, diagnostics, and more without needing hospitalization.
                    </div>
                  </div>
                </div>
                <div class="panel">
                ...
                <div class="panel">
                  ...
                  <div id="faq4" class="acod-body collapse" data-bs-parent="#accordion1">
                    <div class="acod-content">United Health Lumina offers a streamlined claims process with flexible reimbursement options, making it easier for members to claim expenses across OPD and in-patient services.
                    </div>
                  </div>
                </div>
                <div class="panel">
                  ...
                  <div id="faq5" class="acod-body collapse" data-bs-parent="#accordion1">
                    <div class="acod-content">Yes, United Health Lumina includes preventive health benefits like routine check-ups, health screenings, and wellness programs to support overall well-being.
                    </div>
                  </div>
                </div>
              </div>
