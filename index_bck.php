      ...
      <div id="healthCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="carousel-overlay light-overlay"></div>
            <img src="project-assets/images/banner/nb-3.png" class="d-block w-100" alt="Health Care Banner">
            <div class="carousel-caption light-text">
              <div class="caption-content">
                <div class="highlight-box">
                  <h2 class="hindi-slogan"><b>बीमारी का डर छोड़ो, UHL से नाता जोड़ो।</b></h2>
                  <h3 class="company-name">United Health Lumina Plans</h3>
                </div>
                <div class="feature-badges">
                  <span class="glass-effect"><i class="fas fa-star"></i> Trusted Healthcare</span>
                  <span class="glass-effect"><i class="fas fa-shield-alt"></i> Complete Coverage</span>
                  <span class="glass-effect"><i class="fas fa-clock"></i> 24/7 Support</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption light-text">
              <div class="caption-content">
                <div class="highlight-box">
                  <h2 class="hindi-slogan"><b>Comprehensive Health Plans</b></h2>
                </div>
                <div class="feature-badges">
                  <span class="glass-effect"><i class="fas fa-hospital"></i> Cashless Hospitals</span>
                  <span class="glass-effect"><i class="fas fa-user-md"></i> Expert Doctors</span>
                  <span class="glass-effect"><i class="fas fa-ambulance"></i> Emergency Care</span>
                </div>
                <a href="/health-plans" class="cta-button shine-effect">Explore Plans</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption light-text">
              ...
              <div class="caption-content">
                <div class="highlight-box">
                  <h2 class="hindi-slogan"><b>Advanced Health Tests</b></h2>
                </div>
                <div class="feature-badges">
                  <span class="glass-effect"><i class="fas fa-home"></i> Home Collection</span>
                  <span class="glass-effect"> <i class="fas fa-flask"></i>Latest Equipment</span>
                  <span class="glass-effect"><i class="fas fa-file-medical-alt"></i> Quick Reports</span>
                </div>
                <a href="/health-tests" class="cta-button shine-effect">Book Test</a>
              </div>
            </div>
          </div>
        </div>
