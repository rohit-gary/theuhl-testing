...
include '../uhladmin/controllers/common_controllers.php';
...
if (isset($data['name'], $data['email'], $data['policyNumber'], $data['amount'], $data['paymentStatus'])) {
...
if ($paymentStatus && $paymentStatus == 'Success') {
    ...
    $Main_File_Path = "../uhladmin/uhl-management/service-reports/service-report-pdf/$File_Path";
