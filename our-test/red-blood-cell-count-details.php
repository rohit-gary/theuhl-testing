...
<body id="bg" style="z-index:10">
  <div class="page-wraper">
    ...
    <div class="container" style="background-color: #ddd; border-radius: 15px; padding: 40px;">
        <div class="row align-items-center">
            <!-- Product Image Section -->
            <div class="col-md-6">
                <img src="../project-assets/images/generic-old-2.png" alt="test-desktop-banner" class="img-fluid rounded" style="max-width: 100%; border-radius: 10px;">
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mt-4" style="font-size: 18px; font-weight: bold;">
                    <span style="color: #795548; text-decoration: line-through; margin-right: 10px; font-size: 20px;">&#8377; 267</span>
                ...
                <!-- Add to Cart Button -->
                <div class="mt-4">
                    <button class="btn cart-btn btn-success w-100 py-3" data-product-id="<?php echo $all_test[0]['ID']?>" data-product-name="<?php echo $all_test[0]['TestName']?>" data-product-price=" <?php echo $all_test[0]['TestFee']?>" style="border-radius: 8px; font-size: 18px; font-weight: 700;">
                        Add to Cart
                    </button>
                </div>
            </div>
                ...
                <div class="card shadow-lg border-light rounded-3">
                    <div class="card-body py-4">
                        ...
                        <div id="requisitesCarousel" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <!-- Carousel Controls -->
                            <button class="carousel-control-prev" type="button" data-bs-target="#requisitesCarousel" data-bs-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button" data-bs-target="#requisitesCarousel" data-bs-slide="next">
           ...
           <section class="my-5">
            <div class="container">
              <div class="about-test">
                  ...
                  <p>A Red Blood Cell test determines the total number of erythrocytes or red blood cells (RBCs) present in your blood. RBCs are produced in the bone marrow, the soft tissue inside large bones, and contain haemoglobin, an iron-rich protein essential for transporting oxygen. This oxygen supports cell growth, reproduction, and energy production, all necessary for your body to function. They also carry carbon dioxide, a waste product, back to your lungs to be exhaled.
                   A healthy RBC count is crucial for your overall well-being. If you live in Bangalore, you can schedule an RBC test in Bangalore to help detect issues related to abnormal counts early, often before symptoms appear, allowing for prompt diagnosis and effective treatment.</p>
              </div> 

               <div class="list-parameter">
                  <h2 class="title">Red Blood Cell Count (RBC Count) Test Parameters</h2>
                  <p>The Red Blood Cell test evaluates only one parameter: the total number of RBCs present in your blood sample.</p>
                  <p>This test is typically included as part of a complete blood count (CBC), which measures the number of different types of cells in your blood. A small amount of your blood sample is required for testing. The process is instant, usually taking less than five minutes.</p>
              </div>
                ...
                <div class="test-preparation">
                  ...
                  <ul>
                      ...
                      <p>This test is often included in a CBC during routine checkups. It may also be needed to monitor treatments or investigate symptoms of abnormal red blood cell counts.</p>
                  ...
                  <ul>
                      <li><b>Routine health checkups:</b> To assess overall health as part of a complete blood count (CBC) during regular medical examinations.</li>
                      <li><b>Diagnosing anaemia :</b>To detect anaemia, a condition caused by low levels of healthy red blood cells.</li>
                      <li><b>Monitoring chronic conditions:</b> To assess the effects of health conditions such as chronic kidney disease that can affect red blood cell production.</li>

                      <li><b>Evaluating symptoms :</b> To investigate symptoms which may indicate abnormal RBC levels. Indications of a low RBC count may include:
                      <ul>
                      ...
                      <li>Indications of a high red blood cell count may include:
                        <ul>
                          ...
                          <li>Dizziness</li>
                          <li><b>Monitoring medical treatments :</b> To check the impact of treatments such as chemotherapy that may affect blood cell counts.</li>
                            ...
                            <div class="dlab-accordion faq-1 box-sort-in m-b30" id="accordion1">
                                ...
                                <div class="panel">
                                    ...
                                    <div id="faq3" class="acod-body collapse" data-bs-parent="#accordion1">
                                        <div class="acod-content">Yes, United Health Lumina provides customizable health plan options to cater to specific medical needs, lifestyle requirements, and family size.</div>
                                    </div>
                                </div>
                                ...
                                <div class="panel">
                                    ...
                                    <div id="faq5" class="acod-body collapse" data-bs-parent="#accordion1">
                                        <div class="acod-content">Yes, United Health Lumina includes preventive health benefits like routine check-ups, health screenings, and wellness programs to support overall well-being.</div>
                                    </div>
                                </div>
                                <div class="panel">
                                    <div class="acod-head">
                                    ...
                                    <div id="faq6" class="acod-body collapse" data-bs-parent="#accordion1">
                                        <div class="acod-content">United Health Lumina partners with a network of hospitals and clinics to provide seamless access to quality healthcare services.</div>
                                    </div>
                                </div>
                                <div class="panel">
                                    <div class="acod-head">
                                    ...
                                    <div id="faq7" class="acod-body collapse" data-bs-parent="#accordion1">
                                        <div class="acod-content">Yes, United Health Lumina allows you to add family members to your plan, ensuring comprehensive coverage for your spouse, children, or other dependents.</div>
                                    </div>
                                </div>
                            </div>
