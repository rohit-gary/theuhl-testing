                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12 pe-lg-5 mb-5 mb-lg-0">
                        <div class="content-bx1 animation-block">
                            <div style="font-size: 20px; font-weight: 600;">
                                <p class="">UNITED HEALTH LUMINAIS YOUR IDEAL FINANCIAL
                                    rotection against
                                    healthcare expenses (OPP. Consultation & Diagnos).
                                    that Can vive out of unexpected medical treatement. </p>
                                <p class="mt-.3">It is a
                                    Comprehensive
                                    Preimany
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="image-wrapper position-relative">
                            <div class="video-bx">
                                <img src="project-assets/images/Happy_Family[1].jpg" alt="Signature">
                            </div>
                        </div>
                    </div>
                </div>
