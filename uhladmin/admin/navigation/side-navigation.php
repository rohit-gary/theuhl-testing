                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="./admin-dashboard">
                            <img src="../project-assets/images/mobile-logo.png" class="header-brand-img desktop-logo" alt="logo">
                            ...
                            <img src="../project-assets/images/mobile-logo.png" class="header-brand-img light-logo1" alt="logo">
                        </a>
                        <!-- LOGO -->
                    </div>
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            ?>
                                <li class="slide">
                                    <a class="side-menu__item" id="nav_organization" data-bs-toggle="slide" href="../organization/view-organization.php"><i class="side-menu__icon fa fa-building"></i><span class="side-menu__label">Organizations </span></a>
                                </li>    
                            <?php
                            }
                            if($navigation->_Nav_Company)
                            ...
                            ?>
                                <li class="slide">
                                    <a class="side-menu__item" id="nav_modules" data-bs-toggle="slide" href="../modules/view-modules.php"><i class="side-menu__icon fa fa-building"></i><span class="side-menu__label">Modules </span></a>
                                </li>
                            <?php
                           }
