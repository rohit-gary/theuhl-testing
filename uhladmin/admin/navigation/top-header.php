    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.php">
                <img src="./project-assets/images/dwd_logo.png" class="header-brand-img desktop-logo w-50" alt="logo">
                <img src="./project-assets/images/dwd_logo.png" class="header-brand-img light-logo1 w-50" alt="logo">
            </a>
            <!-- LOGO -->
