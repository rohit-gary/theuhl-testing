                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                        <div class="icon-bx-wraper bx-style-1 p-lr20 p-tb30 center seth radius-sm">
                            ...
                            <div class="icon-content">
                                ...
                                <p><a href="mailto:someone@example.com">info@example.com</a> <br> <a href="mailto:someone@example.com">info@example.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                        <div class="icon-bx-wraper bx-style-1 p-lr20 p-tb30 center seth radius-sm">
                            ...
                            <div class="icon-content">
                                ...
                                <p><a href="tel:+4733378901">+00 1234 5678 90 <br> +00 234 678 9012</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
