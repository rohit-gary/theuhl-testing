<form id="customer_form" onsubmit="return false;">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Name" name="poc_name" id="poc_name"
                        value="<?php echo isset($customerForm['poc_name']) ? $customerForm['poc_name'] : ''; ?>">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Contact Number" name="poc_contact_number"
                        id="poc_contact_number" oninput="validateNumericInput(this)"
                        value="<?php echo isset($customerForm['poc_contact_number']) ? $customerForm['poc_contact_number'] : ''; ?>">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" placeholder="Email" autocomplete="username" name="email"
                        id="email" value="<?php echo isset($customerForm['email']) ? $customerForm['email'] : ''; ?>">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="ZIP Code" name="pincode" id="pincode"
                        value="<?php echo isset($customerForm['pincode']) ? $customerForm['pincode'] : ''; ?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Home Address" name="address" id="address"
                value="<?php echo isset($customerForm['address']) ? $customerForm['address'] : ''; ?>">
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Home Address" name="p_address" id="p_address"
                value="<?php echo isset($customerForm['address']) ? $customerForm['address'] : ''; ?>">
        </div>
    </div>
