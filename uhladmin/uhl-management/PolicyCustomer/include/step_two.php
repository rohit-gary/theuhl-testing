            ...
            <div class="card shadow-sm plan-card" id="plan-card-<?php echo $plan['ID']; ?>" onclick="togglePlanSelection(<?php echo $plan['ID']; ?>)">
                ...
                <div class="card-body">
                   ...
                   <button class="btn btn-warning" onclick="event.stopPropagation(); openPlanDetailsModel(<?php echo htmlspecialchars(json_encode($plan), ENT_QUOTES, 'UTF-8'); ?>)">
                    ...
                    <div class="check-mark" id="check-mark-<?php echo $plan['ID']; ?>" style="display: <?php echo $isSelected ? 'block' : 'none'; ?>;">
                        <i class="fas fa-check-circle text-success"></i>
                    </div>
                    <div class="plan-card" id="plan-card-<?php echo $plan['ID']; ?>" class="<?php echo $isSelected ? 'selected' : ''; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-3">
                    <img id="modalPlanImage" src="" alt="Plan Image" class="img-fluid rounded" style="width: 250px; height: auto;">
