    ...
    <div class="page">
        <div class="page-main">
            ...
            <div class="main-content app-content mt-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-4">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                            ...
                                            style="border-radius: 50%; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; padding: 0;display: none;">
                                        ...
                                        <div class="col-md-6 mt-4">
                                            <button class="btn btn-secondary" data-bs-toggle="modal"
                                                data-bs-target="#addMemberModal" onclick="AddFamily()"
                                                style="display: none;">Add Family Member</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="card mt-5 shadow-sm"
                                        ...
                                        <div class="card-body px-4 py-4"
                                            ...
                                            <table class="table table-borderless align-middle">
                                                <tbody>
                                                    <tr>
                                                        <th style="width: 30%; text-align: left; color: #6c757d;">Policy
                                                            Name:</th>
                                                    ...
                                                    <tr>
                                                        <th style="text-align: left; color: #6c757d;">Policy Number:
                                                        </th>
                                                        <td><?php echo htmlspecialchars(
                                                    ...
                                                    <tr>
                                                        <th style="text-align: left; color: #6c757d;">Contact Number:
                                                        </th>
                                                        <td><?php echo htmlspecialchars(
                                                    ...
                                                    <tr>
                                                        <th style="width: 30%; text-align: left; color: #6c757d;">DOB:
                                                        </th>
                                                        <td><?php echo htmlspecialchars(
                                                            $PolicyDetails["DOB"]
                                                        ); ?></td>
                                                    ...
                                                    <tr>
                                                        <th style="width: 30%; text-align: left; color: #6c757d;">
                                                            PermanentAddress :</th>
                                                        <td><?php echo htmlspecialchars(
                                                    ...
                                                    <tr>
                                                        <th style="text-align: left; color: #6c757d;">Policy Start Date:
                                                        </th>
                                                        <td><?php echo htmlspecialchars(
                                                            $formattedDate
                                                        ); ?></td>
                                                    ...
                                                    <tr>
                                                        <th style="text-align: left; color: #6c757d;">Policy End Date:
                                                        </th>
                                                        <td><?php echo htmlspecialchars(
                                                            $expiryFormattedDate
                                                        ); ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button onclick="copyPaymentLink()" class="btn btn-link p-0"
                                                                style="color: #007bff; text-decoration: underline; font-size: 14px;"><i
                                                                    class="ion ion-clipboard"></i></button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card mt-5 shadow-sm"
                                                    ...
                                                    <div class="card-header text-white d-flex justify-content-between align-items-center"
                                                        ...
                                                        <span
                                                            class="badge <?php echo $transaction['status'] === 'Success' ? 'bg-success' : 'bg-danger'; ?>">
                                                    ...
                                                    <div class="card-body px-4 py-4"
                                                        ...
                                                        <table class="table table-borderless align-middle">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="text-align: left; color: #6c757d;">Payment ID:
                                                                    </th>
                                                                    <td><?php echo htmlspecialchars($transaction['razorpay_payment_id']); ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th style="text-align: left; color: #6c757d;">Order ID:</th>
                                                                    <td><?php echo htmlspecialchars($transaction['razorpay_order_id']); ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th style="text-align: left; color: #6c757d;">Amount:</th>
                                                                    <td>₹<?php echo htmlspecialchars(number_format($transaction['amount'], 2)); ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th style="text-align: left; color: #6c757d;">Refund Amount:
                                                                    </th>
                                                                    <td>₹<?php echo htmlspecialchars(number_format($transaction['refundamount'], 2)); ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th style="text-align: left; color: #6c757d;">Status:</th>
                                                                    <td><?php echo htmlspecialchars($transaction['status']); ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th style="text-align: left; color: #6c757d;">Date:</th>
                                                                    <td><?php echo htmlspecialchars(date("d-m-Y", strtotime($transaction['created_at']))); ?>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-6">
                                        <div class="card mt-5 shadow-sm text-center"
                                            style="border-radius: 10px; overflow: hidden; border: 1px solid #ddd;">
                                            ...
                                            <div class="card-body px-4 py-4"
                                                ...
                                                <p class="text-muted" style="font-size: 0.9rem;">No transaction details are
                                                    available at the moment.</p>
                                                <?php if ($_SESSION['dwd_UserType'] !== 'Policy Customer'): ?>
                                                    <button class="btn btn-warning" data-bs-toggle="modal"
                                                        data-bs-target="#editPaymentModal">Edit Payment</button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editPaymentModalLabel">Edit Payment Details
                                                </h5>
                                                <button class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">X</span>
                                                </button>
                                            </div>
                                            <form id="payments_form" onsubmit="return false;"
                                                enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" id="policy_id"
                                                            name="policy_id" value="<?php echo $PolicyID ?>" required
                                                            readonly>
                                                        <label for="razorpay_payment_id">Transaction ID</label>
                                                        <input type="text" class="form-control" id="razorpay_payment_id"
                                                            name="razorpay_payment_id" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="razorpay_order_id">Order ID (If Not Give Transaction
                                                            ID )</label>
                                                        <input type="text" class="form-control" id="razorpay_order_id"
                                                            name="razorpay_order_id" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="amount">Policy Amount</label>
                                                        <input type="number" class="form-control" id="policy_amount"
                                                            name="policy_amount"
                                                            value="<?php echo $PolicyDetails["TotalAmount"] ?>"
                                                            readonly>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="amount_refund"
                                                            name="amount_refund" step="0.01" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="payment_mode"
                                                            name="payment_mode" onchange="toggleBankDetails()">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" id="UpdatePaymentsBtn"
                                                        onclick="UpdatePayments()">Update Payment</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <?php endif; ?>
                                    <div class="row">
                                        <?php foreach ($PolicyMemberDetails as $member): ?>
                                            <div class="col-md-4">
                                                <!-- Family Member Card -->
                                                <div class="card mb-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <!-- Upload Button -->
                                                        <p>(Please Upload Adhar card of this family Member) <span
                                                                style="color:red">*</span></p>
                                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                            data-bs-target="#uploadModal<?php echo $member[
                                                                "ID"
                                                            ]; ?>">
                                                            Upload Document
                                                        </button>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form method="POST" enctype="multipart/form-data" id="member_documents_<?php echo $member[
                                                                        ...
                                                                        <input type="hidden" id="form_action"
                                                                            name="form_action" value="" />
                                                                        <input type="hidden" id="form_id" name="form_id"
                                                                            value="" />
                                                                        <div class="modal-body">
                                                                            <input type="hidden" name="policy_member_id"
                                                                            ...
                                                                            <div id="documents_container_member">
                                                                                <div class="input-group mb-2">
                                                                                    ...
                                                                                    <button type="button"
                                                                                        ...
                                                                                        onclick="addFileInputMember()">+</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                id="UplodeMemberDocuments"
                                                                                onclick="UplodeMemberDocumentsBtn(event)">Upload
                                                                                Document</button>
                                                                        </div>
                                                                    </form>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mt-5">
                                            ...
                                            <?php if (
                                                ...
                                                <div class="alert alert-info mt-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h4 class="card-title mb-1">Please Upload Your Necessary
                                                                Documents for KYC Purpose</h4>
                                                            <p class="mb-0">Ensure that all required documents are uploaded
                                                                for a smooth KYC process. This will help us verify your
                                                                details quickly.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <?php foreach ($PolicyDocumentsDetails as $document): ?>
                                                    <div class="col-md-4">
                            ...
                            <div class="modal-body">
                                <form id="policyDocuments_form" onsubmit="return false;" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-6">
                                            <input type="hidden" class="form-control" id="policy_ID" name="policy_ID"
                                                value="<?php echo $PolicyID; ?>">
                                        </div>

                                        <div class="mb-3 col-6">
                                            <input type="hidden" class="form-control" id="policy_number"
                                                name="policy_number" value="<?php echo htmlspecialchars(
                                                    $policy[
                                                        "PolicyNumber"
                                                    ]
                                                ); ?>">
                                        ...
                                        <div class="mb-3 col-12">
                                            ...
                                            <div id="documents_container">
                                                <div class="input-group mb-2">
                                                    <input type="file" class="form-control" id="documents_0"
                                    ...
                                    <div class="mt-5 text-center">
                                        <button class="btn btn-success text-white" id="UplodeDocumentsBtn"
                                            onclick="AddUploade()">Upload Document</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="addMemberModal" tabindex="-1" aria-labelledby="addMemberLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="numFamilyMembers" class="form-label">Enter the number of family members
                                        you want to add:</label>
                                    <input type="number" class="form-control" id="numFamilyMembers"
                                        placeholder="Enter a number" min="1" max="<?php echo htmlspecialchars(
                                            $maxFamilyMembers
                                        ); ?>">
                                </div>
                                <button type="button" class="btn btn-primary" onclick="generateFamilyMemberForms()">Add
                                    Member</button>

                                <!-- Step 2: Family member forms go here -->
                                <form id="familyMemberForm" action=" " method="POST" style="display: none;"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn btn-success text-white" id="saveMemberDetailsBtn"
                                            onclick="savefamilyMember()">Save Family</button>
        ...
        <div class="col-md-12">
            ...
            <script>
                ...
                document.getElementById("amount").addEventListener("input", function () {
                    let policyAmount = parseFloat(document.getElementById("policy_amount").value) || 0;
                    let amount = parseFloat(this.value) || 0;

                    let refundAmount = amount - policyAmount;
                    document.getElementById("amount_refund").value = refundAmount.toFixed(2);
                });
