...
<head>
    ...
    $PolicyDetails = $PolicyDetails_obj->getPolicyCustomerDetailsByPolicyID(
        $PolicyID
    );

    $PolicyMemberDetails = $PolicyDetails_obj->getPolicyCustomerMemberDetailsByPolicyID(
        $PolicyID
    );

    $PolicyDocumentsDetails = $PolicyDetails_obj->getPolicyDocumentsDetailsByPolicyID(
        $PolicyID
    );

    // print_r($PolicyDocumentsDetails);
    // die();
    ...
    $transDetails=$trans_obj->GetAllTransactionByPolicyID($PolicyID);

    $StateDetailss = $state_obj->GetStateNameByID($policy["State"]);
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-4">
                            <div class="row">
                                <div class="col-md-6">
                                    <p>Upload Document</p>
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadDocumentModal" style="border-radius: 50%; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; padding: 0;">
