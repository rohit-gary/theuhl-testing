                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="test_name" class="col-form-label">Test Name<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="test_name" id="test_name" placeholder="Enter Test Name">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="test_cat" class="col-form-label">Test Category<span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="test_code" class="col-form-label">Test Code<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="test_code" id="test_code" placeholder="Enter Test Code">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="test_fee" class="col-form-label">Test Fee<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" name="test_fee" id="test_fee" placeholder="Enter Test Fee">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="report_time" class="col-form-label">Report Time</label>
                                                    <input type="text" class="form-control" name="report_time" id="report_time" placeholder="Enter Report Time">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="parameters" id="parameters" placeholder="Enter Parameters">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="requisites" class="col-form-label">Requisites</label>
                                                    <input type="text" class="form-control" name="requisites" id="requisites" placeholder="Enter Requisites">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label for="measures" class="col-form-label">Measures</label>
                                                    <input type="text" class="form-control" name="measures" id="measures" placeholder="Enter Measures">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="identifies" id="identifies" placeholder="Enter Identifies">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    <label for="home_minutes" class="col-form-label">Home Minutes</label>
                                                    <input type="text" class="form-control" name="home_minutes" id="home_minutes" placeholder="Enter Home Minutes">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    <label for="happy_customer" class="col-form-label">Happy Customer</label>
                                                    <input type="text" class="form-control" name="happy_customer" id="happy_customer" placeholder="Enter Happy Customer">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group mb-3">
                                                    <label for="google_rating" class="col-form-label">Google Rating</label>
                                                    <input type="text" class="form-control" name="google_rating" id="google_rating" placeholder="Enter Google Rating">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="heading_one" id="heading_one" placeholder="Enter Heading One">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="heading_two" class="col-form-label">Heading Two</label>
                                                    <input type="text" class="form-control" name="heading_two" id="heading_two" placeholder="Enter Heading Two">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="heading_three" class="col-form-label">Heading Three</label>
                                                    <input type="text" class="form-control" name="heading_three" id="heading_three" placeholder="Enter Heading Three">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="heading_four" class="col-form-label">Heading Four</label>
                                                    <input type="text" class="form-control" name="heading_four" id="heading_four" placeholder="Enter Heading Four">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" name="description_one" id="description_one" placeholder="Enter Description One" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="description_two" class="col-form-label">Description Two</label>
                                                    <textarea class="form-control" name="description_two" id="description_two" placeholder="Enter Description Two" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="description_three" class="col-form-label">Description Three</label>
                                                    <textarea class="form-control" name="description_three" id="description_three" placeholder="Enter Description Three" rows="3"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="description_four" class="col-form-label">Description Four</label>
                                                    <textarea class="form-control" name="description_four" id="description_four" placeholder="Enter Description Four" rows="3"></textarea>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="mt-5 text-center">
                                            <button class="btn btn-success text-white" id="addUpdateTBtn" onclick="AddUpdateTest()"></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
