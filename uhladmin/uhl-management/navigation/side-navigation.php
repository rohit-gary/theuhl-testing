    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1"
                href="https://unitedhealthlumina.com/uhladmin/uhl-management/dashboard/main-dashboard">
        ...
        <div class="main-sidemenu" style="overflow: auto; max-height: 100%;">
            ...
            <ul class="side-menu">
                ...
                <?php if ($navigation->_Nav_Dashboard) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                            href="../dashboard/main-dashboard"><i class="side-menu__icon fe fe-home"></i><span
                ...
                <?php if ($navigation->_Nav_Dashboard_Customer) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                            href="../dashboard/policy-customer-main-dashboard"><i
                ...
                <?php if ($navigation->_Nav_Plan) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_servive_reports" data-bs-toggle="slide"
                            href="../plans/view-all-plans"><i class="side-menu__icon fa fa-heartbeat"></i><span
                                class="side-menu__label">Plan</span></a>
                    </li>
                ...
                <?php if ($navigation->_Nav_Customer) { ?>
                    ...
                    <li>
                        <a class="side-menu__item" href="../PolicyCustomer/view-all-customer-new"
                ...
                <?php if ($navigation->_Nav_Neft) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                            href="../accountant/view-all-accountant"><i
                                class="side-menu__icon fa fa-arrow-circle-right"></i><span class="side-menu__label">All
                                Neft/Bank Transfer</span></a>
                    ...
                    <li class="slide">
                        <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                            href="../accountant/view-all-company-neft-account"><i
                                class="side-menu__icon fa fa-building"></i><span class="side-menu__label">Company Neft
                                Account</span></a>
                    </li>

                    <li class="slide">
                        <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                            href="../accountant/view-all-company-bank-account"><i
                                class="side-menu__icon fa fa-bank"></i><span class="side-menu__label">Company Bank
                                Account</span></a>
                    </li>
                ...
                <?php if ($navigation->_Nav_Account) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                            href="../transaction/view-all-transaction"><i class="side-menu__icon ion-cash"></i><span
                ...
                <?php if ($navigation->_Nav_Company) { ?>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_company" data-bs-toggle="slide"
                            href="../company/view-companies"><i class="side-menu__icon fa fa-building"></i><span
                                class="side-menu__label">Companies</span></a>
                    </li>
                <?php } ?>
                <?php if ($navigation->_Nav_Company_Sites) { ?>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_company_sites" data-bs-toggle="slide"
                            href="../company/view-company-sites?nav=1"><i
                                class="side-menu__icon zmdi zmdi-city-alt"></i><span class="side-menu__label">Company
                                Sites</span></a>
                    </li>
                <?php } ?>
                <?php if ($navigation->_Nav_Service_Reports) { ?>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_servive_reports" data-bs-toggle="slide"
                            href="../service-reports/view-all-service-reports"><i
                                class="side-menu__icon fa fa-address-card"></i><span class="side-menu__label">Service
                                Reports</span></a>
                    </li>
                <?php } ?>
                <?php
                if ($navigation->_Nav_Services) { ?>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_services" data-bs-toggle="slide"
                            href="../services/view-services"><i class="side-menu__icon fa fa-address-card"></i><span
                                class="side-menu__label">All Services</span></a>
                    </li>
                <?php }
                if ($navigation->_Nav_Users) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_user" data-bs-toggle="slide" href="../users/view-users"><i
                                class="side-menu__icon fa fa-users"></i><span class="side-menu__label">Users</span></a>
                    </li>
                <?php }

                if ($navigation->_Nav_Channel_Partner) { ?>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_user" data-bs-toggle="slide"
                            href="../channel-partner/view-all-channel-partner"><i
                                class="side-menu__icon fa fa-users"></i><span class="side-menu__label">Channel
                                Partner</span></a>
                    </li>
                <?php }
                ...
                if ($navigation->_Nav_Configuration) { ?>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_configuration" data-bs-toggle="slide"
                            href="../configuration/view-configuration"><i class="side-menu__icon fa fa-gear"></i><span
                                class="side-menu__label">Configuration</span></a>
                    </li>
                <?php }
                ?>
                ...
                <?php if ($navigation->_Nav_Users) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_user" data-bs-toggle="slide" href="../doctors/view-doctors"><i
                                class="side-menu__icon fa fa-stethoscope"></i><span
                ...
                <?php if ($navigation->_Nav_DocTest) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_doctest" data-bs-toggle="slide"
                            href="../doctest/view-all-doctest"><i class="side-menu__icon fa fa-flask"></i><span
                                class="side-menu__label">All Test </span></a>
                    </li>

                    <li class="slide">
                        <a class="side-menu__item" id="nav_doctest" data-bs-toggle="slide"
                            href="../doctest/view-all-test-package"><i class="side-menu__icon fa fa-medkit"></i><span
                                class="side-menu__label">All Test Package</span></a>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" id="nav_doctest" data-bs-toggle="slide"
                ...
                <?php if ($navigation->_Nav_faqs) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_servive_reports" data-bs-toggle="slide"
                            href="../faqs/view-all-faqs"><i class="side-menu__icon  fa fa-info-circle"></i><span
                ...
                <?php if ($navigation->_Nav_Document) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_servive_reports" data-bs-toggle="slide"
                            href="../PolicyCustomer/view-policy-details?PolicyID=<?php echo $Policy_ID; ?>"><i
                                class="side-menu__icon fa fa-heartbeat"></i><span class="side-menu__label">My Health Plan
                            </span></a>
                    </li>
                ...
                <?php if ($navigation->_Nav_Reimbursement) { ?>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" id="nav_servive_reports" data-bs-toggle="slide"
                            href="../reimbursement/view-all-reimbursement"><i
                                class="side-menu__icon   fa fa-money"></i><span
                                class="side-menu__label">Reimbursement</span></a>
                    </li>
