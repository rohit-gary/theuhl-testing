    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="#">
                <img src="../project-assets/images/logo-green.png" class="header-brand-img desktop-logo w-50" alt="logo">
                <img src="../project-assets/images/logo-green.png" class="header-brand-img light-logo1 w-50" alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown"
                                    ...
                                    <img src="https://png.pngtree.com/png-vector/20220709/ourmid/pngtree-businessman-user-avatar-wearing-suit-with-red-tie-png-image_5809521.png" alt="profile-user"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-left">
                                            ...
                                            {
                                                $email_top_header = $_SESSION['dwd_email'];
                                                $top_header_UserType = $_SESSION['dwd_UserType'];
                                            }
                                            ?>
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold"><?php echo $email_top_header; ?></h5>
                                    ...
                                    <?php
                                    if(isset($_SESSION['multi_modules']))
                                    {
                                        if($_SESSION['multi_modules'] == 1)
                                        {
                                            ?>
                                            <a class="dropdown-item" href="../../dwd-organization/dashboard/app-dashboard">
                                                <i class="dropdown-icon fe fe-alert-circle"></i> Switch App
                                            </a>
                                            <?php
                                        }
                                    }
                                    ?>
                                    <a class="dropdown-item" href="../../admin/authentication/logout">
