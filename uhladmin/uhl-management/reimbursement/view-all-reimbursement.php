...
// Get all policy numbers for the logged-in user
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header mb-3">
                            ...
                            <h1 class="page-title d-flex align-items-center">Apply for Reimbursement
                                <span data-bs-placement="bottom" data-bs-toggle='tooltip'  data-bs-original-title='Add Leave' onclick="AddReimbursement(<?php echo $PolicyID; ?>)" class="fe fe-plus add_btn"></span>
                            </h1>
                                            ...
                                            <table class="table table-bordered text-nowrap border-bottom"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">CheckupDate/Time</th>
                                                        <th class="wd-15p border-bottom-0">CheckupCost</th>
                                                        <th class="wd-25p border-bottom-0">CehckupDocuments</th>
                            ...
                            <form id="reimbursement_form" onsubmit="return false;" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" class="form-control " id="checkup_cost"
                                            name="checkup_cost">
                                    </div>
                                   ...
                                   <div class="mb-3 col-6">
                                        ...
                                        <div id="checkup_documents_container">
                                            <div class="input-group mb-2">
                                                <input type="file" class="form-control" id="checkup_documents_0" name="checkup_documents[]">
