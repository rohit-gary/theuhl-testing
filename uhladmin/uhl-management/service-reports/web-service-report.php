...
$mpdf->SetHTMLHeader('<div style="border-bottom: none; text-align:right; margin-right:10px;">{PAGENO}/{nb}</div>');
        ...
        <div class="page_2">
            ...
            <div class="bottom_div">
                <table class="bottom_signature_table" style="border-bottom:none;">
                    <tbody>
                        <tr>
                            <td class="bottom_table_bold" colspan="2">RPM Enterprises Technician</td>
                        </tr>
                        <tr>
