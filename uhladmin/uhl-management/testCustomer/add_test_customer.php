...
<head>
    ...
    <title>Add Test Customer - United Health Lumina</title>
    <?php
    ...
    $Customerid = isset($_SESSION['UserID']) ? $_SESSION['UserID'] : '';
    $TestFormId= isset($_SESSION['UserID']) ? $_SESSION['UserID'] : '';
    $TestForm=[];
  

    $selectedTests = isset($TestForm['Test']) ? $TestForm['Test'] : [];
    // print_r($policyForm);
    // die();
    ?>
...
<body class="app sidebar-mini ltr light-mode">
                    ...
                    <div class="main-container container-fluid">
                        <div class="container my-5">
                            <div class="text-center mb-4">
                                <h3 class="display-6 fw-bold">Add Test Customer</h3>
                                ...
                                <div class="col-lg-8">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="step-box active">
                                            ...
                                            <p class="step-title">Customer Registration</p>
                                        </div>
                                        <div class="step-line"></div>
                                        <div class="step-box">
                                            <span class="step-number">2</span>
                                            <p class="step-title">Choose Test</p>
                                        </div>
                                        <div class="step-line"></div>
                                        <div class="step-box">
                                            <span class="step-number">3</span>
                                            <p class="step-title">Check Out Page Link</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="step-1" class="form-section active">
                                <div class="card">
                                    <div class="card-header">Step 1: User Registration</div>
                                    <div class="card-body">
                                        <?php include("include/step_one_test.php") ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="step-2" class="form-section">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Step 2: Choose Tests</h5>
                                        <a href="javascript:void(0)" class="btn btn-outline-secondary position-relative" 
                                    ...
                                    <div class="card-body">
                                        <?php include("include/step_two_test.php") ?>
                            ...
                            <div id="step-3" class="form-section">
                                <div class="card">
                                    <div class="card-header">Step 3: Purchase Summary</div>
                                    <div class="card-body">
                                        <?php include("include/step_four_test.php") ?>
                                    </div>
                                </div>
                            </div>       
                    </div>
    ...
    <div id="paymentLinkModal" class="modal fade" tabindex="-1" aria-labelledby="paymentLinkModalLabel"
    ...
    <div class="modal fade" id="familyMemberModal" tabindex="-1" aria-labelledby="familyMemberModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="familyMemberForm">
                        ...
                        <label for="familyMemberSelect" class="form-label fw-bold d-flex align-items-center">
                            Select Plan
                            <span id="refreshBadgePlan" class="badge bg-primary ms-2" style="cursor: pointer;"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="ad_member_name" name="member_name"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ad_member_gender_male"
                                    name="member_gender" value="male" required>
                                <label class="form-check-label" for="member_gender_male">Male</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="ad_member_gender_female"
                                    name="member_gender" value="female" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" id="ad_member_relationship" name="member_relationship"
                                required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="saveAdditionalFamilyMember()"
                        form="familyMemberForm">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../project-assets/js/customer-test.js"></script>
     <script src="../project-assets/js/booking-test.js"></script>
