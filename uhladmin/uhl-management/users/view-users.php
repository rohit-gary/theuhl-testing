                                                    ...
                                                    foreach ($all_user_details as $user) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            if ($AdminAccess) {
                                                                ?>
                                                                <td class="text-left">
                                                                    <a onclick="ResetPassword('<?php echo $UserEmail; ?>');"><span
                                                                            class="badge bg-danger badge-sm  me-1 mb-1 mt-1 cursor-pointer fe fe-settings fs-14">&nbsp;Reset</span></a>
                                                                </td>
                                                                <td>
                                                                    <div class="g-2">
                                                                        ...
                                                                        <a class="btn text-danger btn-sm"
                                                                            data-bs-toggle="tooltip"
                                                                            onclick="UpdateUser(<?php echo $UserID; ?>)"
                        ...
                        <div class="modal-body">
                            <form id="user_form" onsubmit="return false;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="recipient-name" class="col-form-label">User Email (Will be used for
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" maxlength="10" class="form-control" name="user_pan"
                                            id="user_pan" placeholder="Enter PAN">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control" placeholder="Please Enter Employee Address"
                                            rows="2" name="ta_address" id="ta_address"></textarea>
                                    </div>
                                </div>
